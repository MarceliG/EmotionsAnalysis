...
COLUMNS = ["joy", "trust", "anticipation", "surprise", "fear", "sadness", "disgust", "anger", "valence", "arousal"]
...
def lemmatize(text: list[str]) -> list[str]:
    def lemmatizer(wl: nltk.stem.WordNetLemmatizer, text: list[str], pos: str) -> list[str]:
